...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Draw_button->setText(QApplication::translate("MainWindow", "Draw", Q_NULLPTR));
